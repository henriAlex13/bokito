...
def page_kpi_module(is_admin):
    ...
    tab_crc, tab_sat, tab_sat_pro = st.tabs(["📞 KPI CRC", "😊 Satisfaction", "⭐ SAT PRO"])
    with tab_crc:
...
def page_accueil():
    style.home_page(
        "Plateforme Réclamations SGCI",
        "Choisissez un module pour continuer.",
        [
            {
                "icon": "📊", "title": "Dashboard Réclamations",
                "desc": "Analysez les réclamations, SLA, agences et segments.",
                "color": "#58a6ff", "href": "?espace=reclamations", "btn_label": "Ouvrir le dashboard",
            },
            {
                "icon": "🌐", "title": "Ressource Externe",
                "desc": "Accédez à une ressource de référence externe.",
                "color": "#3fb950", "href": RESSOURCE_EXTERNE_URL, "btn_label": "Ouvrir le lien", "external": True,
            },
            {
                "icon": "📈", "title": "Tableau de Bord KPI",
                "desc": "Suivez les KPI : CRC, Satisfaction, SAT PRO.",
                "color": "#ffa657", "href": "?espace=kpi", "btn_label": "Ouvrir le module KPI",
            },
        ],
    )
...
def main():
    ...
    espace = st.query_params.get("espace")
