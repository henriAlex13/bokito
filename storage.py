...
CSV_SCHEMAS = {
    MX103_CSV:       ['filename', 'filepath', 'cle_32A', 'adresse_debtor', 'date', 'montant'],
    MT910_CSV:       ['filename', 'filepath', 'cle_32A', 'texte_72', 'date', 'montant'],
    MATCHES_CSV:     ['match_id', 'cle_32A', 'filename_mx', 'filename_mt', 'date_mx', 'date_mt'],
